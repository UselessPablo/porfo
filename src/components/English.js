    ...
    <ThemeProvider theme={selectedTheme}>
      ...
      <Box className={backgroundClass} sx={{ width: '100%', height: '100%' }}>
        ...
        <Drawer anchor="left" open={isDrawerOpen} onClose={closeDrawer} PaperProps={{ sx: { backgroundColor: selectedTheme.palette.secondary.main, color: selectedTheme.palette.primary.main } }}>
          <Typography textAlign={'center'} sx={{ mt: 4 }}>Pablo A.</Typography>
          <Typography textAlign={'center'} sx={{ mt: 1 }}>Proyects</Typography>
          <List >
